...
distancias <- function (CLASS, category, dist) {
  ...
  #plot(dens$x,length(diff_to_TSS_data_capped[[5]])*dens$y,type="l",xlab="Value",ylab="Count estimate")
  
  #barplot(diff_to_TSS_data_capped[[1]], main = paste(category, "\n", type.dist),
  #        col =  myPalette)
  # Percentage of perfect match
